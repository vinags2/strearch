...
<template>
    ...
    <div class="flex min-h-screen flex-col items-center  bg-gradient-to-r from-cyan-200 to-blue-300 p-6 text-[#1b1b18] dark:bg-[#0a0a0a] lg:justify-center lg:p-8">
        ...
        <div class="duration-750 starting:opacity-0 flex w-full items-center justify-center opacity-100 transition-opacity lg:grow">
            <main class="flex w-full max-w-[335px] flex-col-reverse overflow-hidden rounded-lg lg:max-w-4xl lg:flex-row">
                ...
                >
                    <h1 class="mb-1 font-medium">Welcome to Strearch</h1>
                    <p class="mb-2 text-[#706f6c] dark:text-[#A1A09A]">
                        Strearch is a tool for searching your Strava activities, and comparing your performances over time.
                        You may apply filters to view a subset of your activities and order your activities as you see fit.
                    </p>
                    <p class="mb-2 text-[#706f6c] dark:text-[#A1A09A]">
                ...
                <div
                    class="relative -mb-px aspect-[335/376] w-full shrink-0 overflow-hidden rounded-t-lg bg-gradient-to-r from-cyan-200 to-blue-300 dark:bg-[#1D0002] lg:-ml-px lg:mb-0 lg:aspect-auto lg:w-[438px] lg:rounded-r-lg lg:rounded-t-none"
                >
                <svg xmlns="http://www.w3.org/2000/svg"
                    width="438" height="438" viewBox="0 0 24 24"
                    fill="none" stroke="#afffff" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                >
